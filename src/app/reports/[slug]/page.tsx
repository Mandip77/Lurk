            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="font-bold text-white text-lg">
                  {isWhiteLabel ? report.agency_name : 'Sentinel AI'}
                </h1>
                {report.client_name && (
        ...
        <div className="max-w-4xl mx-auto px-8 py-8 space-y-8">
          ...
          <div className="border-t border-slate-800 pt-6 text-center text-slate-500 text-sm">
            {isWhiteLabel ? (
              ...
              <p>Generated by <a href="https://sentinelai.dev" className="text-[#00FF94] hover:underline">Sentinel AI</a> · {new Date(report.created_at).toLocaleDateString()}</p>
            )}
          </div>
        </div>
      </div>
