...
<div class="cover">
  <div class="cover-brand">
    ...
    {% endif %}
    <span class="brand-name">{{ agency_name if agency_name else 'Sentinel AI' }}</span>
  </div>
...
<div class="page">
  <div class="report-footer">
    {% if agency_name and agency_name != 'Sentinel AI' %}
    {{ agency_name }}{% if client_name %} · Prepared for {{ client_name }}{% endif %} ·
    {% endif %}
    Generated by Sentinel AI · {{ report_date }} ·
...
def build_context(data: dict) -> dict:
    ...
    return {
        ...
        "agency_name": data.get("agency_name", "Sentinel AI"),
...
def main():
    parser = argparse.ArgumentParser(description="Sentinel AI report generator")
